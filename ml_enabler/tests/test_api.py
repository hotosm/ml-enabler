...
class PredictionAPITest(BaseTestCase):
    def test_no_model(self):
        ...
        response = self.client.post('/v1/model/1/prediction',
    ...
    def test_post(self):
        ...
        response = self.client.post(f'/v1/model/{ml_model.id}/prediction',
                                    data=json.dumps(prediction_payload),
                                    content_type='application/json')
    ...
    def test_get(self):
        ...
        response = self.client.get(f'/v1/model/{ml_model_id}/prediction?'
...
class PredictionTileAPITest(BaseTestCase):
    def test_post(self):
        ...
        response = self.client.post(f'/v1/model/prediction/{prediction.id}/tiles',
    ...
    def test_geojson_post(self):
        ...
        response = self.client.post(f'/v1/model/{prediction.model_id}/tiles/geojson',
                                    data=json.dumps(payload),
                                    content_type='application/json')
    ...
    def test_get(self):
        ...
        prediction = create_prediction()
        create_prediction_tiles(prediction.id)
        response = self.client.get(f'/v1/model/{prediction.model_id}/tiles?bbox=10.013795,53.5225,10.048885,53.540843&zoom=18')
        assert(response.status_code == 200)
    ...
    def test_get_outside_bbox(self):
        ...
        prediction = create_prediction()
        create_prediction_tiles(prediction.id)
        response = self.client.get(f'/v1/model/{prediction.model_id}/tiles?bbox=10.05,53.52,10.08,53.54&zoom=18')
